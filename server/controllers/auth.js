...
export const sendRegistrationMail = async (req, res) => {
  try {
    ...
    console.log("sendRegistrationMail ", otp, email, name);
    ...
    const response = await axios({
      ...
      data: {
        sender: {
          name: "Zaemon Connects",
          email: "prabhavdobhal45@gmail.com",
        },
        to: [
          {
            email: email,
        ...
        subject: "Registration OTP Zaemon Connects",
        htmlContent: `<p>Your registration otp for Zaemon Connects is ${otp}</p>`,
        replyTo: {
          email: "prabhavdobhal45@gmail.com",
          name: "Zaemon Connects",
        },
